...
platform_left = Player("img/slider.png", 50, 200, 5, 55, 80)  # Update to point to slider.jpg
platform_right = Player("img/slider.png", 600, 200, 5, 55, 80)  # Update to point to slider.jpg
